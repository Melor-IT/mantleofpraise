    ...
    <div className="page ANBI-Information">
            ...
            <ul>
              <li>
                {formatMessage({
                  id: 'policyGoals1',
                  defaultMessage:
                    'Het bevorderen van christelijke aanbidding en geestelijke vorming.'
                })}
              </li>
              <li>
                {formatMessage({
            ...
            <ul>
              <li>
                {formatMessage({
                  ...
                  defaultMessage:
                    'Het organiseren van aanbidding bijeenkomsten, conferenties en trainingen.'
                })}
              </li>
              <li>
                {formatMessage({
      ...
      <section className="primary">
        <div className="page-content">
          <div className="text-block">
            <h2>
              {formatMessage({ id: 'policyIncomeTitle', defaultMessage: '3. Inkomstenbronnen' })}
            </h2>
            <p>
              {formatMessage({
          ...
          <div className="text-block">
            ...
            <ul>
              <li>
                {formatMessage({
                  id: 'policyExpenses1',
                  defaultMessage: 'Het organiseren van activiteiten en evenementen.'
                })}
              </li>
              <li>
                {formatMessage({
              ...
              <li>
                {formatMessage({
                  id: 'policyExpenses4',
                  defaultMessage: 'Ondersteuning van kerken en bedieningen.'
                })}
              </li>
              <li>
                {formatMessage({
                  id: 'policyExpenses5',
                  defaultMessage: 'Algemene beheers- en organisatiekosten.'
                })}
              </li>
            </ul>
          </div>
