    ...
    <div className="page ANBI-Information">
      ...
      <section>
        ...
        <div className="page-content">
          <h1>
            {formatMessage({ id: 'beleidsplanTitle', defaultMessage: 'Beleidsplan Stichting Mantle of Praise' })}
          </h1>
        </div>
      </section>

      {/* Section 1 – Doelstelling / هدف */}
      <section className="primary">
        <div className="page-content">
          <div className="text-block">
            <h2>{formatMessage({ id: 'policyGoalsTitle', defaultMessage: '1. Doelstelling van de instelling' })}</h2>
            <p>
              {formatMessage({ id: 'policyGoalsIntro', defaultMessage: 'De organisatie Stichting Mantle of Praise heeft als doel:' })}
            </p>
            <ul>
      ...
      <section className="secondary">
        <div className="page-content">
          <div className="text-block">
            <h2>{formatMessage({ id: 'policyActivitiesTitle', defaultMessage: '2. Activiteiten om dit doel te bereiken' })}</h2>
            <ul>
      ...
      <section className="primary">
        <div className="page-content">
          <div className="text-block">
            <h2>{formatMessage({ id: 'policyIncomeTitle', defaultMessage: '3. Inkomstenbronnen' })}</h2>
            <p>{formatMessage({ id: 'policyIncomeIntro', defaultMessage: 'De inkomsten van de organisatie bestaan uit:' })}</p>
            <ul>
      ...
      <section className="secondary">
        <div className="page-content">
          <div className="text-block">
            <h2>{formatMessage({ id: 'policyExpensesTitle', defaultMessage: '4. Besteding van de middelen' })}</h2>
            <p>{formatMessage({ id: 'policyExpensesIntro', defaultMessage: 'De bestedingen van de organisatie zijn gericht op:' })}</p>
            <ul>
      ...
      <section className="primary">
        <div className="page-content">
          <div className="text-block">
            <h2>{formatMessage({ id: 'policyAssetsTitle', defaultMessage: '5. Beheer van het vermogen' })}</h2>
            <p>
