const messages = {
  ...
  team: 'Our Team',
  teamText:
    'In Mantle of Praise, we are not just a team; we are a spiritual family. A family that worships God together, learns from one another, serves hand in hand, and grows deeper in faith every day. Although the leadership of the ministry is carried out by the Leadership Team under the spiritual oversight of the Levites, the truth is that each of us is a living part of this Body. Everyone serves in their own place, and together we build up the church.',
